 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:9999/WeatherWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICESERVICE_QNAME = new QName("http://ws/", "WeatherServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/WeatherWS?wsdl");
    ...
    public WeatherWS getWeatherWSPort() {
        return super.getPort(new QName("http://ws/", "WeatherWSPort"), WeatherWS.class);
    }
    ...
    public WeatherWS getWeatherWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "WeatherWSPort"), WeatherWS.class, features);
    }
